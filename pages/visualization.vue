            ...
            <v-row no-gutters>
              <v-col>
                <v-card class="ma-1">
                  ...
                  <v-card-text>
                    <distribution :dist-data="distData" :moran-i="moranI" :chart-height="heights.dist" />
                  </v-card-text>
                </v-card>
              </v-col>
            </v-row>
            ...
            <v-row no-gutters>
              <v-col>
                <v-card class="ma-1">
                  ...
                  <v-card-text>
                    <scatter :scatter-data="scatterData" :line-data="lineData" :chart-height="heights.scatter" />
                  </v-card-text>
                </v-card>
              </v-col>
            </v-row>
          ...
          <v-col cols="7">
            ...
            <v-row no-gutters>
              <v-card class="ma-1" width="100%">
                ...
                <v-card-text>
                  <local-index-map :moran-data="moranData" :pvalues-local="pvaluesLocal" :chart-height="heights.map" />
                </v-card-text>
              </v-card>
            </v-row>
          </v-col>
          ...
          <v-col cols="12" align-self="start">
            ...
            <v-card-text class="mb-3 text-subtitle-1">
              ...
              <ul>
                ...
                <li>{{ $t('visualization_link_description_1') }} <a :href="$t('visualization_link_address_1')" target="_self">{{ $t('visualization_link_alias_1') }}</a></li>
...
export default {
  ...
  methods: {
    ...
    setDataToIndex (index) {
      this.setChartData(this.messages[index].value)
    },
    setChartData (data) {
      this.windowStart = data.windowStart
      this.windowEnd = data.windowEnd
      this.moranI = parseFloat(data.moranI)
      this.pvalue = data.pvalue
      this.slope = parseFloat(data.regressionSlope)
